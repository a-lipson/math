...
#problem[ 
  $f$ is holo on the disk $D_(R_0)$ centered at the origin with radius $R_0$.

  + Prove, for $0<R<R_0$, $|z|<R$, 
    #grid( // why does this center everything?
      columns: (1fr),
...
#proof(of: "(a)")[
  ...
  Thus,
  $
  f(z) = 1/(2 pi) integral_(0)^(2 pi) f(R e^(i phi)) "Re"lr([ (R e^(i phi) + z)/(R e^(i phi) - z) ])  dd phi,
...
#proof(of: "(b)")[
  ...
  Thus, 
  $
  "Re" lr([ (R e^(i gamma) + r)/(R e^(i gamma ) - r) ]) = (R^2 - r^2)/ (R^2 - 2 R r cos gamma + r^2)
  $ as desired.
]
